...
(function () {
    ...
    function renderFields(context) {
        ...
        resultHtml += renderFieldBlock(context, 2, 10, "IssueAddressZkh");
        resultHtml += '</div>';

        resultHtml += '<div class="form-group">';
        resultHtml += renderFieldBlock(context, 2, 10, "IssueDescriptionZkh");
        resultHtml += '</div>';

        resultHtml += '<div class="form-group">';
        resultHtml += renderFieldBlock(context, 2, 10, "IssueInvestorZkh");
        resultHtml += '</div>';

        resultHtml += '<div class="form-group">';
        resultHtml += renderFieldBlock(context, 2, 4, "IssueCadastreIdZkh");
        resultHtml += renderFieldBlock(context, 2, 4, "IssueDecisionTypeZkh");
        resultHtml += '</div>';

        resultHtml += '<div class="form-group">';
        resultHtml += renderFieldBlock(context, 2, 4, "IssueCategoryZkh");
        resultHtml += renderFieldBlock(context, 2, 4, "IssueReporterZkh");
        resultHtml += '</div>';

        resultHtml += '<div class="form-group">';
        resultHtml += renderFieldBlock(context, 2, 4, "IssueMunicipalDistrictZkh");
        resultHtml += renderFieldBlock(context, 2, 4, "IssueSettlementZkh");
        resultHtml += '</div>';

        resultHtml += '<div class="form-group">';
        resultHtml += renderFieldBlock(context, 2, 10, "IssueDecisionZkh");
        resultHtml += '</div>';

        resultHtml += '<div class="form-group">';
        resultHtml += renderFieldBlock(context, 2, 10, "IssueThemeZkh");
        resultHtml += '</div>';

        resultHtml += '<div class="form-group">';
        resultHtml += renderFieldBlock(context, 2, 4, "IssueNumberZkh");
        resultHtml += renderFieldBlock(context, 2, 4, "IssueMeetingZkh");
        resultHtml += '</div>';
    ...
    SP.SOD.executeOrDelayUntilScriptLoaded(function () {
        init();
        SP.SOD.executeOrDelayUntilScriptLoaded(function () {
            RegisterModuleInit(SPClientTemplates.Utility.ReplaceUrlTokens("~siteLayouts/GS.Zkh.Web/Scripts/csr/renderIssueZkh.js"), init);
        }, 'sp.js');
    }, 'clienttemplates.js');
})();
