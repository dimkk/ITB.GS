...
namespace GS.Land.Jobs
{
    public class AssignmentProlongationJob : SPJobDefinition
    {
        public static readonly string JobName = "ГС.Земля: Продления поручений";
        
        public static readonly string AssignmentListName = "AssignmentLandList";
        public static readonly string AssignmentProlongationCountFieldName = "AssignmentProlongationCountLand";
        public static readonly string AssignmentFactDateFieldName = "AssignmentFactDateLand";

        public static readonly string ReportListName = "ReportLandList";
        public static readonly string ReportDecisionFieldName = "ReportDecisionLand";
        public static readonly string ReportAssignmentFieldName = "ReportAssignmentLand";
