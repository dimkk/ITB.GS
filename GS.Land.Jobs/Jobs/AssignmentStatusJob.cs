...
namespace GS.Land.Jobs
{
    ...
    {
        public static readonly string JobName = "ГС.Земля: Статусы поручений";

        public static readonly string AssignmentListName = "AssignmentLandList";
        public static readonly string AssignmentStatusFieldName = "AssignmentStatusLand";
        public static readonly string AssignmentPlanDateFieldName = "AssignmentPlanDateLand";
