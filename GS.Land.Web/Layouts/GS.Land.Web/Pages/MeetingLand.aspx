...
<asp:Content ID="PageHead" ContentPlaceHolderID="PlaceHolderAdditionalPageHead" runat="server">
    ...
    <script type="text/javascript" src="../Scripts/Model/MeetingLand.js"></script>
...
<asp:Content ID="Main" ContentPlaceHolderID="PlaceHolderMain" runat="server">
                ...
                <div class="form-horizontal" role="form">
                    <div class="form-group topspace">
                        <div class="col-lg-2">
                            ...
                            <label data-bind="text: meeting().MeetingDateLand"></label>
                        </div>
                        <div class="col-lg-5">
                            <label style="font-weight: normal">Место проведения:</label>
                            <label data-bind="text: meeting().MeetingPlaceLand"></label>
                        </div>
                    </div>
                        ...
                        <table class="table evenodd" id="IssueTableTable">
                            ...
                            <tbody data-bind="foreach: issues">
                                <tr>
                                    ...
                                    <td data-bind="text: IssueAddressLand"></td>
                                    <td data-bind="text: IssueInvestorLand"></td>
                                    <td data-bind="text: IssueDescriptionLand"></td>
            ...
            <div id="tab-additional" class="tab-pane fade">
                <div class="form-horizontal" role="form">
                    <div class="form-group topspace">
                        ...
                        <div class="col-lg-3">
                            <input data-bind="value: meeting().MeetingNumberLand, enable: editEnabled" type="text" class="form-control" id="inputNumber" placeholder="Номер заседания">
                        </div>
    ...
    optionsText: 'name',
    optionsValue: 'name',
    value: meeting().MeetingStatusLand,
    enable: editEnabled">
                            </select>
                        </div>
                    </div>
