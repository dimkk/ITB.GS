...
namespace GS.Land.Receivers
{
    ...
    public class MeetingItem : SPItemEventReceiver
    {
        ...
        private readonly string dateFieldName = "MeetingDateLand";
        private readonly string numberFieldName = "MeetingNumberLand";
        ...
        public override void ItemAdded(SPItemEventProperties properties)
        {
            ...
            using (new SPMonitoredScope("GS.Land.MeetingItemAdded"))
            {
        ...
        public override void ItemDeleting(SPItemEventProperties properties)
        {
            ...
            using (new SPMonitoredScope("GS.Land.MeetingItemDeleting"))
            {
                SPSecurity.RunWithElevatedPrivileges(delegate()
                {
                    using (var site = new SPSite(properties.SiteId))
        ...
        public override void ItemUpdating(SPItemEventProperties properties)
        {
            ...
            try
            {
                ...
                using (new SPMonitoredScope("GS.Land.MeetingItemUpdating"))
                {
                    SPSecurity.RunWithElevatedPrivileges(delegate()
                    {
                        using (var site = new SPSite(properties.SiteId))
    ...
    {
        public static string EventLogCategory { get { return "GS.Land Event Receivers (document sets)"; } }
        public static string TraceLogCategory { get { return "GS.Land Event Receivers (document sets)"; } }
    }
}
