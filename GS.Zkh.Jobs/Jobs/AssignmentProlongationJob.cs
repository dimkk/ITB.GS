...
namespace GS.Zkh.Jobs
{
    ...
    {
        public static readonly string JobName = "ГС.ЖКХ: Продления поручений";
        
        public static readonly string AssignmentListName = "AssignmentZkhList";
        public static readonly string AssignmentProlongationCountFieldName = "AssignmentProlongationCountZkh";
        public static readonly string AssignmentFactDateFieldName = "AssignmentFactDateZkh";

        public static readonly string ReportListName = "ReportZkhList";
        public static readonly string ReportDecisionFieldName = "ReportDecisionZkh";
        public static readonly string ReportAssignmentFieldName = "ReportAssignmentZkh";
