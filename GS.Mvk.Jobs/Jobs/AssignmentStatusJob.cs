...
namespace GS.Mvk.Jobs
{
    ...
    {
        public static readonly string JobName = "ГС.МВК: Статусы поручений";

        public static readonly string AssignmentListName = "AssignmentMVKList";
        public static readonly string AssignmentStatusFieldName = "AssignmentStatusMVK";
        public static readonly string AssignmentPlanDateFieldName = "AssignmentPlanDateMVK";
